    ...
    <div className="flex flex-col text-lg p-6">
      ...
      <nav className="text-sm text-gray-500 mb-4">
        <ol className="list-reset flex">
          ...
          <li><span className="mx-2">/</span></li>
          <li className="text-gray-700">All Orders</li>
        </ol>
      </nav>
        ...
        <div className="mt-6 overflow-x-auto">
          <table className="min-w-[1200px] divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                {[
                  "Order ID", "Payment ID", "Customer Name", "Email", "Phone", "Country", 
                  "State", "City", "Pincode", "Total Items", "Sub Total", "Discount", 
                  "Coupon Discount", "Total Amount", "Order Status", "Actions"
                ].map((heading) => (
                  <th
                    key={heading}
